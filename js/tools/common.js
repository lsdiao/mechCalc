...
(function () {
  ...
  var HARD_HRC = [
    ...
    [32, 312, 301], [35, 331, 323], [38, 367, 352], [40, 392, 371], [42, 409, 394],
    [45, 446, 429], [48, 484, 460], [50, 513, 481], [52, 548, 510], [55, 595, 543],
    [58, 654, 600], [60, 697, 653], [62, 766, 710], [65, 856, 790], [68, 940, 872]
  ]; // [HRC, HV, HBW]（GB/T 1172 常用段锚点）
  var HARD_HRB = [
  ...
  App.registerTool({
   ...
   keywords: '钢材 重量 圆钢 钢板 钢管 方钢 六角钢 角钢 理论重量',
    ...
    compute: function (v) {
      ...
      switch (v.shape) {
        ...
        case 'square':
          ...
          break;
        case 'hex':
          A = Math.sqrt(3) / 2 * p1 * p1; // (√3/2)·S²，S 为对边距离（≈0.866S²）
    ...
    formulas: [
      ...
      '方钢 A=a²；六角 A=(√3/2)S²≈0.866S²（S 对边距）；角钢 A≈(2b-t)t',
      'W = A·L·ρ/1000（kg）'
    ],
