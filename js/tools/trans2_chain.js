/* =========================================================
 * 机械传动类工具 —— 滚子链传动设计计算
 * 1:1 复刻 原站「链传动设计计算」工具（逐值一致，已 API 探针验证）
...
(function () {
  ...
  App.registerTool({
    ...
    reference: 'GB/T 18150-2000（2006确认）《滚子链传动选择指导》（工况系数 f1 表、额定功率图表、润滑方式选用）；GB/T 1243 传动用短节距精密滚子链（链号与节距系列）。1:1 复刻自 原站 滚子链传动设计计算：'
  });
})();
